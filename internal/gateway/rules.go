...
var commandRules = []PatternRule{
	...
	{ID: "CMD-KUBECTL-DELETE-ALL", Pattern: regexp.MustCompile(`(?i)(?:\bkubectl\b[^\n{}]*(?:-n\s+|--namespace(?:=|\s+))(?:defenesclaw|kube-system|default)\b[^\n{}]*\bdelete\b|\bkubectl\b[^\n{}]*\bdelete\b[^\n{}]*(?:--all\b|\bnamespaces?\b|\ball\b|(?:-n\s+|--namespace(?:=|\s+))(?:defenesclaw|kube-system|default)\b))`), Title: "Destructive Kubernetes delete", Severity: "CRITICAL", Confidence: 0.88, Tags: []string{"destructive", "kubernetes"}},
