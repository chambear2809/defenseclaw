...
# 8ac9b51bbd5c7a732b6073ce7bc2fc92cf24a62e. Runtime pods never pull GitHub
# or install Python dependencies from PyPI.
gh workflow run splunk-cisco-skills-bundle.yml \
  -f source_sha=8ac9b51bbd5c7a732b6073ce7bc2fc92cf24a62e \
  -f publish=true
...
kubectl -n defenseclaw exec deploy/openclaw -- \
  sh -c 'release=/home/node/.openclaw/splunk-cisco-skills/releases/8ac9b51bbd5c7a732b6073ce7bc2fc92cf24a62e; test -f "$release/.complete" && test "$(cat "$release/.revision")" = "9bb131a104830b166dc0918b1be89332a7a8ada4"'
