...
# f70a6c12d26126b17ccf33b579a279ebcfaa7be2. Runtime pods never pull GitHub
# or install Python dependencies from PyPI.
gh workflow run splunk-cisco-skills-bundle.yml \
  -f source_sha=f70a6c12d26126b17ccf33b579a279ebcfaa7be2 \
  -f publish=true
...
kubectl -n defenseclaw exec deploy/openclaw -- \
  sh -c 'release=/home/node/.openclaw/splunk-cisco-skills/releases/f70a6c12d26126b17ccf33b579a279ebcfaa7be2; test -f "$release/.complete" && test "$(cat "$release/.revision")" = "2bce17ff8f2f29afd6f5326d7976d20c251538a4"'
