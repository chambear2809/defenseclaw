...
# 215e2c2305dca67512b3f28865dd2e8e54406254. Runtime pods never pull GitHub
# or install Python dependencies from PyPI.
gh workflow run splunk-cisco-skills-bundle.yml \
  -f source_sha=215e2c2305dca67512b3f28865dd2e8e54406254 \
  -f publish=true
...
kubectl -n defenseclaw exec deploy/openclaw -- \
  sh -c 'release=/home/node/.openclaw/splunk-cisco-skills/releases/215e2c2305dca67512b3f28865dd2e8e54406254; test -f "$release/.complete" && test "$(cat "$release/.revision")" = "9bb131a104830b166dc0918b1be89332a7a8ada4"'
