...
# 3a944d4afd7b9b955bba921d3a54f11de1095a68. Runtime pods never pull GitHub
# or install Python dependencies from PyPI.
gh workflow run splunk-cisco-skills-bundle.yml \
  -f source_sha=3a944d4afd7b9b955bba921d3a54f11de1095a68 \
  -f publish=true
...
kubectl -n defenseclaw exec deploy/openclaw -- \
  sh -c 'release=/home/node/.openclaw/splunk-cisco-skills/releases/3a944d4afd7b9b955bba921d3a54f11de1095a68; test -f "$release/.complete" && test "$(cat "$release/.revision")" = "9bb131a104830b166dc0918b1be89332a7a8ada4"'
