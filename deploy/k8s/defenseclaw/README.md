...
# b9c3df3790e042ecdb518fa5455c7bb27720f850. Runtime pods never pull GitHub
# or install Python dependencies from PyPI.
gh workflow run splunk-cisco-skills-bundle.yml \
  -f source_sha=b9c3df3790e042ecdb518fa5455c7bb27720f850 \
  -f publish=true
...
kubectl -n defenseclaw exec deploy/openclaw -- \
  sh -c 'release=/home/node/.openclaw/splunk-cisco-skills/releases/b9c3df3790e042ecdb518fa5455c7bb27720f850; test -f "$release/.complete" && test "$(cat "$release/.revision")" = "2bce17ff8f2f29afd6f5326d7976d20c251538a4"'
