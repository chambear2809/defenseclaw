...
| `OTEL_EXPORTER_OTLP_ENDPOINT` | Connector-process OTLP endpoint, and legacy gateway exporter input during upgrade |
| `OTEL_EXPORTER_OTLP_HEADERS` | Connector-process OTLP headers, and legacy gateway exporter input during upgrade |
